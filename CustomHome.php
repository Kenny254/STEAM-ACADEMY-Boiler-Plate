        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 order-md-1 order-sm-2 order-2">
                <div class="h-1-banner-text mb-3">
                    ...
                    ?>
                    <h1>STEAM <span class="d-inline-block">ACADEMY </span><h1>
                        
                 <h1 style="font-size: 25px;">Discover, <span class="d-inline-block"> Create,</span> Innovate</h1>
...
<section class="courses grid-view-body py-5">
    <div class="container">
        <h1  class="text-center" class="pt-0"><span><?php echo site_phrase('top_courses'); ?></span></h1>
